...
export default function WorkflowsPage() {
  ...
  if (loading) {
    return <div className="max-w-5xl mx-auto p-8">Loading workflows...</div>;
  }
  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/workflows/new" className="border px-4 py-2 rounded">
          New Workflow
        </Link>
      </div>

      {workflows.length === 0 ? (
        <div className="border rounded p-6">No workflows found.</div>
      ) : (
